...
export const defaultImageFactory = (id: string) => (
  <svg
    viewBox='0 0 200 200'
  ...
  >
    <defs>
      ...
      <circle id={`${id}-d`} cx={18.823} cy={18.823} r={18.823} />
      <rect
        id={`${id}-b`}
        x={3.5}
        y={9}
    ...
    <g fill='none' fillRule='evenodd'>
      ...
      <g transform='rotate(-90 102.429 55.357)'>
        ...
        <use fill='#377EFF' xlinkHref={`#${id}-b`} />
        <path
      ...
      <g transform='translate(132.857 124)'>
        ...
        <use fill='#FBBE47' fillRule='nonzero' xlinkHref={`#${id}-d`} />
        <circle
          fill='#FFCD6B'
          fillRule='nonzero'
          mask={`url(#${id}-e)`}
...
export const defaultImage = defaultImageFactory('adm-error-block-default')
